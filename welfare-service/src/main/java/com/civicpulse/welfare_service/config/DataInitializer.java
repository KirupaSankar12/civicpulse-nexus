...
public class DataInitializer implements CommandLineRunner {
    ...
    public void run(String... args) {
        if (schemeRepo.count() == 0) {
            log.info("Seeding initial active welfare schemes...");

            createScheme("PM Awas Yojana", "Housing Department",
                    "Financial assistance for affordable housing constructed for low & middle income citizens.",
                    "Annual Income between ₹50,000 and ₹3,00,000; Age 21-65 years",
                    new BigDecimal("50000"), new BigDecimal("300000"), 21, 65, new BigDecimal("5000000"));

            createScheme("National Scholarship Scheme", "Education Department",
            ...
            createScheme("Old Age Pension", "Social Welfare Department",
            ...
            createScheme("Women Entrepreneurship Scheme", "Social Welfare Department",
            ...
            createScheme("Health Assistance Scheme", "Health Department",
            ...
            createScheme("Farmer Subsidy Scheme", "Agriculture Department",
                    "Direct benefit transfer for agricultural equipment and seed purchases.",
                    "Annual Income up to ₹3,00,000; Age 18-75 years; Land ownership documents required",
                    BigDecimal.ZERO, new BigDecimal("300000"), 18, 75, new BigDecimal("2500000"));

            log.info("Seeded 6 active welfare schemes successfully.");
        }

        if (budgetRepo.count() == 0) {
            log.info("Seeding initial departmental budgets...");

            createBudget("Housing Department", "2025-26", new BigDecimal("10000000"), 85);
            ...
            createBudget("Agriculture Department", "2025-26", new BigDecimal("6000000"), 85);

            log.info("Seeded 5 departmental budgets successfully.");
        }
    }

    private void createScheme(String name, String dept, String desc, String criteria,
                              BigDecimal minInc, BigDecimal maxInc, Integer minAge, Integer maxAge, BigDecimal budget) {
        WelfareScheme s = new WelfareScheme();
